...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Episode seasonHigh = new Episode(1,6,"kappa",45);
        Episode seasonHigher = new Episode(1,7,"kappa",45);
        Episode seasonHigherer = new Episode(1,9,"kappa",45);
        MrRobot.addEpisode(seasonHigh);
        MrRobot.addEpisode(seasonHigher);
        MrRobot.addEpisode(seasonHigherer);
